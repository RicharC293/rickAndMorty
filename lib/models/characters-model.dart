...
//
//     final characteresModel = characteresModelFromJson(jsonString);

import 'dart:convert';

CharacteresModel characteresModelFromJson(String str) =>
    CharacteresModel.fromJson(json.decode(str));

String characteresModelToJson(CharacteresModel data) =>
